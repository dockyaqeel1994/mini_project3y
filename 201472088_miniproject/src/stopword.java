...
public class stopword extends javax.swing.JFrame 
{
	...
	private void initComponents()	//displayComponents
	{
		...
		jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "STOPWORD REMOVAL", 
		...
		btnremove.setFont(new java.awt.Font("Times New Roman", 0, 14)); 
		btnremove.setText("Remove Stopwords ");
		...
		btnremove.setBounds(120, 130, 190, 30);

		jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "FILE CONTENT",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, 
				javax.swing.border.TitledBorder.DEFAULT_POSITION, 
				new java.awt.Font("Times New Roman", 0, 14),
				Color.BLACK)); 
	...
	private void btnremoveActionPerformed(java.awt.event.ActionEvent evt) // button remove stopwords 
	{
		try {
			stopWords.add("a");
			stopWords.add("as");
	...
	}// button remove stopwords 

	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) // button store stop words 
	{
		try
		{
			String s,s1;    
			...
			while ((s = br.readLine()) != null) {
				...
				//	st.executeUpdate("INSERT INTO `stopwords` VALUES (" + cnt + ",'" + s1 + "')");// no database
					cnt++;
				}
			}
	...
	} // button store stop words 

	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) // button Proceed 
	{ 
		group s=new group();
		s.setVisible(true);
	}
